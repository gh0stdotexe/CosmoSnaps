#!/bin/bash
CHAIN_ID="juno-1"
SNAP_PATH="$HOME/site-content/snapshots/juno"
LOG_PATH="$HOME/site-content/snapshots/juno/juno_log.txt"
DATA_PATH="$HOME/.juno/data/"
SERVICE_NAME="junod"
...
log_this "Compressing ${SNAP_PATH}"
lz4 --rm -9 ${SNAP_PATH} ${SNAP_PATH}.lz4 &>>${LOG_PATH}
